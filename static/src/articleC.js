    ...
    <div class="outer">
        <div class="card front">
            ...
            <div class="description">
                <h3>Tokyo, Japan</h3>
                <p>By nr: {{article}}</p>
                <p>Description for this trip. What a cool destination. But what happens to the box when you add a lot of text. If youre an asshole and put to much, what happens? Maybe put a limit in db?</p>
            </div>
        </div>
    </div>
    `,
